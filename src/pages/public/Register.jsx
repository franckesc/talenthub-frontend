...
function Register() {
  ...
  const handleSubmit = (event) => {
    ...
    setMessage(
      "Formulario validado correctamente. El siguiente paso será conectarlo con el backend.",
    );
  };
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={[
                    "h-10 w-full rounded-md border bg-[#f8fafc] px-3 pr-10 text-sm outline-none transition",
                    errors.password
  ...
  return (
    <div>
      ...
      <input
        ...
        className={[
          "h-10 w-full rounded-md border bg-[#f8fafc] px-3 text-sm outline-none transition placeholder:text-slate-400",
          error
            ? "border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-100"
            : "border-slate-300 focus:border-[#103f73] focus:ring-2 focus:ring-blue-100",
        ].join(" ")}
...
function AccountTypeOption({
  ...
  return (
    ...
    >
      ...
      <Icon className="mt-0.5 shrink-0 text-[#103f73]" size={18} />
